...
let valueHour = prompt (`Введіть кількість годин, щоб визначити скільки дана кількість годин має секунд`);
let secondsPerHour  = valueHour * secondsPerMin * minsPerHour ;
alert(`Секунд в ${valueHour} годин ${secondsPerHour}  seconds`);

let valueDay = prompt (`Введіть кількість днів, щоб визначити скільки дана кількість днів має секунд`);
let secondsPerDay = valueDay * secondsPerMin * minsPerHour * hoursPerDay;
alert(`Секунд в ${valueDay} добах ${secondsPerDay}  seconds`);

let valueMonth = prompt (`Введіть кількість місяців, щоб визначити скільки дана кількість місяців має секунд`);
let secondsPerMonth = valueMonth * secondsPerMin * minsPerHour * hoursPerDay * daysPerMonth;
